...
class SuppliesRegistration(models.TransientModel):
    ...
    branch_address = fields.Char(string='Branch Address', required=True)
    ...
    def action_approve(self):
        ...
        raise ValidationError('Invalid state change. Can only approve submitted applications.')
    ...
    def action_finalize(self):
        ...
        if self.state != 'approved':
            raise ValidationError('Invalid state change. Can only finalize approved applications.')
